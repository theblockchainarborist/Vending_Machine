...
public class MenuTest {
	...
	public void displays_a_list_of_menu_options_and_prompts_user_to_make_a_choice() {
		...
		String expected = System.lineSeparator() + "1) " + options[0].toString() + System.lineSeparator() + "2) " + options[1].toString() + System.lineSeparator()
	...
	public void redisplays_menu_if_user_does_not_choose_valid_option() {
		...
		String menuDisplay = System.lineSeparator() + "1) " + options[0].toString() + System.lineSeparator() + "2) " + options[1].toString() + System.lineSeparator()
				 + System.lineSeparator() + "Please choose an option >>> ";
